  ...
  return (
    <React.Fragment>
      ...
      <Containers>
        ...
        <Typography variant="">Last updated: February 01, 2024</Typography>
        <br />
        <Typography variant="">
        ...
        <ul>
          ...
          <li>
            ...
            this Agreement) refers to Sabaiydev Technology Sole co.,Ltd,
            Nongnieng village, Xaisettha distrist, Vientiane, Lao PDR.
            <br />
        ...
        <br />
        <Typography variant="">The third-party vendors We use are:</Typography>
        <br />
        <ul>
          <li>
        ...
        <ul>
          ...
          <li>
            ...
            vendors to provide advertising on our Service, third-party vendors
        ...
        <Typography variant="">Your request to Us must:</Typography>
        <ul>
          <li>
