...
import { CHANGE_USER_PASSWORD } from "../apollo";
...
function ChanagePassowrd() {
  ...
  const [passwordLong, setPasswordLong] = useState(null);
  const [upperPassword, setUpperPassword] = useState(null);
  const [numberPassword, setNumberPassword] = useState(null);
  const [chanagePassowrd] = useMutation(CHANGE_USER_PASSWORD);
