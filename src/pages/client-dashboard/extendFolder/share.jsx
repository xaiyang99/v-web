...
import useFetchSharedSubFoldersAndFiles from "./hooks/useFetchSharedSubFolderAndFiles";
...
function SharedExtendMyFolder() {
  ...
  const { setFolderId, trackingFolderData, trackingShareFolderData } =
  ...
  const fetchSubFoldersAndFiles = useFetchSharedSubFoldersAndFiles(
    parentFolder?._id,
    userAuth,
  );
  ...
  const handleDeleteFilesAndFolders = async () => {
    try {
      await deleteShareFileAndFolder({
        variables: {
          id: dataForEvents.data?.sharedId,
        },
        onCompleted: async () => {
          if (dataForEvents.type === "folder") {
    ...
    <React.Fragment>
      {shareDialog && (
        <CreateShare
          ...
          share={{
            _id: dataForEvents.data.sharedId,
            isFromShare: true,
          }}
        />
      )}
      ...
      {!_.isEmpty(dataForEvents.data) && (
        <FileDetailsDialog
          ...
          {...{
            ...
            downloadIcon: {
              isShow: dataForEvents.data.permission === "edit" ? true : false,
...
export default SharedExtendMyFolder;
